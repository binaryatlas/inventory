 ...
 */
 $config['ldap_uri'] = array('ldap://atu.edu/');
 $config['use_tls'] = false;  // Using SSL above, don't use TLS with it
 $config['search_base'] = 'DC=atu,DC=edu';
 ...
 $config['proxy_user'] = 'CN=Account Operator,OU=Special,DC=atu,DC=edu';  // Or CN=ProxyUser,CN=Users,DC=mycompany,DC=com
 $config['proxy_pass'] = 'Tit@0uPw';
 $config['roles'] = array(1 => 'User', 
                        3 => 'Power User',
                        5 => 'Administrator');
